      ...
      <div className="Rocket-illustration">
        ...
        <div className="Rocket-data-list">
          ...
          <div>
            ...
            <div className="Rocket-data-list-stat">
              {getCirculatingSupply(price, totalSupply) ? formatValue(getCirculatingSupply(price, totalSupply)) : formatValue(0)}
            </div>
          </div>
          <div>
