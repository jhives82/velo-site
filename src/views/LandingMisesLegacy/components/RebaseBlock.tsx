...
import 'components/Rocket/Rocket.css'
...
const RebaseBlock: React.FC = () => {
  ...
  " style={{
    ...
    {getCirculatingMarketCap(price, totalSupply) && <div className="FarmCard-value-locked my-4 py-4">
    	<div className="FarmCard-name flex-1">
    		Market Cap:
    	</div>
    	<div className="flex-1 font-bold" style={{fontSize: '18px', marginTop: '10px'}}>
